...
int main(void)
{
    ...
    /* USART1: 115200, 8 data bits, no parity, 1 stop bit. */
    uart_init(115200);
    ...
    printf("\r\nSTM32 chassis controller ready\r\n");
    printf("F forward, B backward, L left, R right\r\n");
    printf("Q spin-left, E spin-right, S stop\r\n");
    printf("A command is valid for 1 second; resend to keep moving.\r\n\r\n");
